...
// Anti-reframing rule + documentary/heritage clause (2026-09-14): the 6th
// instance of the reframing pattern ("La Ruta del Circo y Organillero",
// approved as "intervención circense en espacio público" the day AFTER
// circus was named above) showed that naming a category isn't enough —
// the model moves to the "intervención" escape hatch. The rule makes the
// escape hatch cost something: a concrete described gesture, not a genre
// in an unusual place. Same day, "Campamento Sewell: 20 años" (historic
// photos, maquetas, panels about a mining camp) was approved and removed
// by Daniel as "documental, nada que ver con arte" — the heritage clause
// names that shape while explicitly keeping artistic photography and
// memory-themed artist shows in. Measured before shipping (local replay,
// 16 real posts × 3 reps): Sewell 3/3 rejected, Frágil como un volantín
// (photo exhibition on democracy) 3/3 still approved on Haiku.
// Online-only events named explicitly (2026-09-14): five "exhibitions"
// with no physical venue were live on the calendar — Galería/Radio Suyai
// TV's PDF artist books and digital graphics (commune "Santiago", via
// chilecultura.gob.cl), Liquenlab "Virtual" — and De Sarmiento Galería's
// digital-only "ENTREACTO 03" came in through Instagram the day before.
// Daniel removed the five by hand; a deterministic venue prefilter now
// covers chilecultura, but the Instagram pipeline has no venue field, so
// the prompt has to say it.
// 5th instance of the same reframing (2026-09-13, Instagram run): "Día del
// Circo Chileno — Muestra de procesos de creación de artes circenses"
// (Casa de la Cultura de Chiguayante) was approved as "el circo como forma
// de arte visual/performance genuino" — a scheduled circus show in a
// theater's main hall. The shadow model rejected it as a conventional
// performing-arts function. Same fix as the recital: name it.
export const ART_SCOPE_POLICY = `Before applying the exclusion axes below, first confirm this event is actually in scope for an art-opening calendar. Included — visual/plastic art exhibitions: painting, drawing, sculpture, printmaking, installations (sound, tactile, or otherwise), and similar visual-art media shown as an exhibition. Included — genuine artistic interventions: a performance or happening staged specifically as an artistic gesture, not as a conventional show — for example a street performance blending dance and theater as a single artistic intervention, an artist inhabiting a public installation, a mass nude-portrait photography event, or a nude-body walk as performance art. Explicitly excluded, regardless of venue prestige or setting: events with no physical venue (an online-only exhibition, a PDF artist book, a YouTube or streaming "exhibition", a radio launch, a platform's "virtual gallery" — the calendar is placed by comuna and exists to send people somewhere; approve a physical show even when a virtual version also exists), conventional theater plays (in their usual theater format), concerts, gigs ("tocatas"), circus shows and circus-arts showcases ("muestra de artes circenses", a scheduled show on a stage is a performing-arts function, not a visual-art gesture), and dance performances in their traditional format/venue — even at a legitimate cultural center that also hosts real exhibitions. Also explicitly excluded: conversatorios, charlas, mesas redondas, or presentaciones de libros (a discussion or talk is not a visual-art exhibition or a performance staged as an artistic gesture, even when it's about art, has musical accompaniment, or is framed as "participatory"), poetry recitals or spoken-word readings ("recital poético," a literary reading is not a visual-art exhibition or a performance staged as an artistic gesture, even when described as "expresión artística"), and generic cultural/heritage days or community festivals ("Día de los Patrimonios," "Fiesta a la Chilena," and similar) unless the specific activity being reported is itself a visual-art exhibition or genuine artistic intervention, not just one activity among many at a broader cultural event. The test is the format, not the medium or the venue: is this a genuine artistic intervention or a visual-art exhibition, or is it a conventional performing-arts show, talk, or generic cultural gathering being staged as usual? The latter is out of scope even when it shares elements (body, music, dance, "art") with what is accepted. Regla anti-reencuadre: si el evento es una función, show, concierto, obra, taller, charla o número de circo, es "rejected" aunque el texto lo llame "intervención", "experiencia", "performance" o "muestra"; la excepción de intervención artística exige que el texto describa el gesto artístico concreto (qué hace el artista, cómo altera el espacio o al espectador), no solo el género en un lugar inusual o al aire libre. Una muestra documental o patrimonial cuyo propósito es informar sobre la historia de un lugar, institución o infraestructura (paneles informativos, maquetas, objetos de archivo, fotografías de registro) tampoco es una exposición de arte visual — distinta de una exposición de fotografía artística o de una muestra de artista sobre memoria, que sí entran. If it's ambiguous whether something is a genuine artistic intervention or essentially a themed concert/show/talk with visual elements, reject it — status is strictly binary (approved/rejected), there is no intermediate review tier, so treat scope ambiguity the same default-exclude way the content axes below already do: no middle ground. If it's clearly a conventional theater play, concert, gig, talk, or show with no artistic-intervention framing, use "rejected" — out of scope, not merely low-priority.`;
