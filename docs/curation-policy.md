...
| "Los archivos de Gabriela" (real case, 2026-09-15) | A municipal culture department and the regional archive show photographs and records of Gabriela Mistral's life — the Nobel ceremony, her face, her travels — Mon-Fri in a theater hall. | Scope (documentary/heritage) | **EXCLUDE** | Archive material displayed to inform about a person is a documentary/heritage show, not a visual-art exhibition — same as "Campamento Sewell: 20 años" the day before. Haiku approved it under the very clause written for Sewell; the shadow model rejected it as "muestra documental/patrimonial". Removed by hand with two siblings from the same run (naval ship models in Ancud; an architect's centenary with a documentary screening and a heritage display). |
