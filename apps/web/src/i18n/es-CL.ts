...
export const esCL = {
  ...
  agregaExpo: {
    ...
    comunaLabel: "Comuna",
    comunaPlaceholder: "Escribe y elige una comuna de la lista",
    artistLabel: "Artista(s)",
    addArtist: "+ Agregar otro artista",
    openingDatetimeLabel: "Fecha y hora de la inauguración",
    runEndDateLabel: "Fecha de término de la muestra",
    descriptionLabel: "Descripción",
    imagesLabel: "Imagen",
    chooseImage: "Elegir imagen",
    changeImage: "Cambiar imagen",
    submitterNameLabel: "Tu nombre",
