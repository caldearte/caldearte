...
export default function CuratoriaBanner() {
  return (
    <Link
      href="/curatoria"
      className="w-full md:w-[838px] mt-16 flex items-end md:items-end gap-[14px] md:gap-[172px]  bg-[rgba(199,212,217,0.62)] rounded-[20px] md:rounded-[30px] px-5 md:px-[62px] py-8 md:py-10"
    >
      ...
      <div className="font-geist text-text-primary tracking-[1px] md:tracking-[2px] uppercase leading-[1.4]">
        <p className="text-[16px] md:text-[20px]">{esCL.curatoriaTeaser}</p>
        <p className="font-bold underline text-brand-magenta text-[16px] md:text-[20px] mt-1 md:mt-2">
          {esCL.verMas}
        </p>
      </div>
    </Link>
