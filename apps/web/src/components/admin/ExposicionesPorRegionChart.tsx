...
// Chart 2: stacked area, STATE semantics (an exhibition counts in every
// period it overlaps) — same read as the "Assets" reference: categories
// (regiones here) stacked so their heights compose a visible total per
// period.
export default function ExposicionesPorRegionChart({
  events,
  periods,
  granularity,
}: {
  ...
  const buckets = countActiveByPeriod(ranges, periods, granularity);
